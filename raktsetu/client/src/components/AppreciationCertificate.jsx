  ...
  <div className="flex flex-col items-center md:items-start select-none pointer-events-none mb-1">
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col items-start -space-y-1">
        <span className="text-xl font-extrabold tracking-[0.1em] text-slate-800 uppercase font-sans">Raktsetu</span>
        ...
        <div className="w-full md:w-[65%] flex flex-col justify-between h-full min-h-[480px]">
          ...
          <div className="flex justify-between items-end w-full max-w-[500px] mt-4 px-2">
            ...
            <div className="text-center">
              ...
              <p className="text-[6.5px] text-slate-400 font-extrabold uppercase tracking-widest leading-none mt-0.5">Founder, RAKTSETU</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[6.5px] text-slate-400 font-extrabold uppercase tracking-widest leading-none mt-0.5">Co-Founder, RAKTSETU</p>
            </div>
